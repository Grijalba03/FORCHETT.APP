...
from src.modelos import Blocked, User,UserProfile, Recipe, Favorite_Recipes, Categories, Recommendations, Reviews, IngredientList
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(IngredientList, db.session))
